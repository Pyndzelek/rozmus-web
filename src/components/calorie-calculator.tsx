            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                ...
                <div className="flex gap-4 mt-4">
                  <div className="w-8 h-8 bg-[var(--brand-accent)] rounded-full flex items-center justify-center text-white font-bold">
                    1
                  </div>
              ...
              <CardContent className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <Slider
                    ...
                    min={40}
                    step={1}
                    className="w-full [&_[data-radix-slider-range]]:bg-[var(--brand-accent)] [&_[data-radix-slider-thumb]]:bg-[var(--brand-accent)] [&_[data-radix-slider-thumb]]:border-white"
                  />
                ...
                <Button className="w-full bg-[var(--brand-accent)] hover:bg-[var(--brand-accent-strong)] text-white py-3 transition-all duration-300 hover:scale-105">
                  Dalej
                </Button>
              </CardContent>
            </Card>
